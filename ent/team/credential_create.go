...
func (_c *CredentialCreate) check() error {
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`team: missing required field "Credential.name"`)}
	}
	...
	if _, ok := _c.mutation.CredType(); !ok {
		return &ValidationError{Name: "cred_type", err: errors.New(`team: missing required field "Credential.cred_type"`)}
	}
	...
	if _, ok := _c.mutation.Encrypted(); !ok {
		return &ValidationError{Name: "encrypted", err: errors.New(`team: missing required field "Credential.encrypted"`)}
	}
	switch _c.driver.Dialect() {
	case dialect.MySQL, dialect.SQLite:
		if _, ok := _c.mutation.CreatedAt(); !ok {
			return &ValidationError{Name: "created_at", err: errors.New(`team: missing required field "Credential.created_at"`)}
		}
	}
	switch _c.driver.Dialect() {
	case dialect.MySQL, dialect.SQLite:
		if _, ok := _c.mutation.UpdatedAt(); !ok {
			return &ValidationError{Name: "updated_at", err: errors.New(`team: missing required field "Credential.updated_at"`)}
		}
	}
	return nil
}
