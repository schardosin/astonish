...
func (_q *McpServerQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *McpServerQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *McpServerQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *McpServerQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *McpServerQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *McpServerQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *McpServerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(mcpserver.Table, mcpserver.Columns, sqlgraph.NewFieldSpec(mcpserver.FieldID, field.TypeUUID))
	_spec.From = _q.sql
