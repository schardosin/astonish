...
const (
	// Label holds the string label denoting the skillfile type in the database.
	Label = "skill_file"
	...
	EdgeSkill = "skill"
	// Table holds the table name of the skillfile in the database.
	Table = "skill_files"
	// SkillTable is the table that holds the skill relation/edge.
	SkillTable = "skill_files"
...
// Columns holds all SQL columns for skillfile fields.
var Columns = []string{
	FieldID,
	FieldSkillID,
	FieldPath,
...
// OrderOption defines the ordering options for the SkillFile queries.
