...
const (
	// Label holds the string label denoting the emailthreadindex type in the database.
	Label = "email_thread_index"
	...
	// Table holds the table name of the emailthreadindex in the database.
	Table = "email_thread_index"
)

// Columns holds all SQL columns for emailthreadindex fields.
var Columns = []string{
	FieldID,
	FieldSessionKey,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the EmailThreadIndex queries.
