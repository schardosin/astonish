...
// cert-bundle PVCs (source: pvc) default to ReadWriteMany (shared across
// sandbox pods) and honor bootstrap.accessMode overrides. RWO defaults
// caused Multi-Attach when concurrent sandboxes (or upgrade + leftover
// pods) shared the claim.
//
