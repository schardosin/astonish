...
const (
	// Label holds the string label denoting the orgmcpserver type in the database.
	Label = "org_mcp_server"
	...
	// Table holds the table name of the orgmcpserver in the database.
	Table = "org_mcp_servers"
)

// Columns holds all SQL columns for orgmcpserver fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldCommand,
...
// OrderOption defines the ordering options for the OrgMCPServer queries.
