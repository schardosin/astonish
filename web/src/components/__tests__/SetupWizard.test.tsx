...
describe('SetupWizard', () => {
  ...
  it('shows the Continue button on the welcome step', () => {
    render(<SetupWizard onComplete={onComplete} />)
    expect(screen.getByText('Continue')).toBeInTheDocument()
  })

  it('has Back button invisible or disabled on the first step', () => {
    render(<SetupWizard onComplete={onComplete} />)
  ...
  it('renders the three overview bullet points on welcome step', () => {
    render(<SetupWizard onComplete={onComplete} />)
  ...
  it('renders as a full-screen overlay', () => {
    const { container } = render(<SetupWizard onComplete={onComplete} />)
