...
function SessionTrace({ sessionId, onRefresh, onNavigate }) {
  ...
  const [selectedThread, setSelectedThread] = useState(null) // null = "All" (raw trace view)
...
function ThreadMessageRow({ msg, index, expanded, onToggle }) {
  ...
  const textPreview = msg.text?.length > 400 ? msg.text.slice(0, 400) + '...' : msg.text
