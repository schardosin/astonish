...
func WireBrowserManager(
	...
	mgr.ContainerStartRecordingFunc = func(podName, display, outPath string) (func() error, int, int, error) {
		return StartRecordingInSandbox(context.Background(), gw, podName, display, outPath)
	}
