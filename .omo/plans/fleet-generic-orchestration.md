...
**Status:** DRAFT rev.2 — evaluator findings applied; awaiting user approval before handoff to worker session.
...
```go
// CapabilityRegistry — advisory list of well-known capability names surfaced in the editor UI as autocomplete hints.
// The runtime never rejects an unknown capability; this is documentation, not enforcement.
var CapabilityRegistry = []string{
    "code.write", "code.review", "code.test",
    "docs.write", "docs.review",
    "design.architecture", "design.ux",
    "ops.deploy", "ops.observe",
    "data.query", "data.transform",
    "research", "planning",
}
```
