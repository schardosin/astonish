      ...
      <div className="p-4" style={{ borderBottom: '1px solid var(--border-color)' }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold" style={{ color: 'var(--text-primary)' }}>astonish</span>
          </div>
          
          {/* Theme Toggle */}
          <button
            onClick={onToggleTheme}
            className="p-2 rounded-lg transition-colors hover:bg-purple-100 dark:hover:bg-purple-900/30"
