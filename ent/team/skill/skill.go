...
const (
	...
	FilesTable = "skill_files"
	// FilesInverseTable is the table name for the SkillFile entity.
	// It exists in this package in order to avoid circular dependency with the "skillfile" package.
	FilesInverseTable = "skill_files"
