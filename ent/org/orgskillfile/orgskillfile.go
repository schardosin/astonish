...
const (
	// Label holds the string label denoting the orgskillfile type in the database.
	Label = "org_skill_file"
	...
	EdgeSkill = "skill"
	// Table holds the table name of the orgskillfile in the database.
	Table = "org_skill_files"
	// SkillTable is the table that holds the skill relation/edge.
	SkillTable = "org_skill_files"
	// SkillInverseTable is the table name for the OrgSkill entity.
	// It exists in this package in order to avoid circular dependency with the "orgskill" package.
	SkillInverseTable = "org_skills"
	// SkillColumn is the table column denoting the skill relation/edge.
	SkillColumn = "skill_id"
)

// Columns holds all SQL columns for orgskillfile fields.
var Columns = []string{
	FieldID,
	FieldSkillID,
	FieldPath,
...
// OrderOption defines the ordering options for the OrgSkillFile queries.
