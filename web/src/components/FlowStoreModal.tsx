...
interface FlowStoreModalProps {
  isOpen: boolean
  onClose: () => void
  onInstall?: (flow: Flow) => void
}
...
export default function FlowStoreModal({ isOpen, onClose, onInstall }: FlowStoreModalProps) {
  ...
  const [activeTab, setActiveTab] = useState<'flows' | 'taps'>('flows') // 'flows' or 'taps'
