...
func PublishedBy(v uuid.UUID) predicate.App {
...
func PublishedByEQ(v uuid.UUID) predicate.App {
	return predicate.App(sql.FieldEQ(FieldPublishedBy, v))
}

// PublishedByNEQ applies the NEQ predicate on the "published_by" field.
func PublishedByNEQ(v uuid.UUID) predicate.App {
	return predicate.App(sql.FieldNEQ(FieldPublishedBy, v))
}

// PublishedByIn applies the In predicate on the "published_by" field.
func PublishedByIn(vs ...uuid.UUID) predicate.App {
	return predicate.App(sql.FieldIn(FieldPublishedBy, vs...))
}

// PublishedByNotIn applies the NotIn predicate on the "published_by" field.
func PublishedByNotIn(vs ...uuid.UUID) predicate.App {
	return predicate.App(sql.FieldNotIn(FieldPublishedBy, vs...))
}

// PublishedByGT applies the GT predicate on the "published_by" field.
func PublishedByGT(v uuid.UUID) predicate.App {
	return predicate.App(sql.FieldGT(FieldPublishedBy, v))
}

// PublishedByGTE applies the GTE predicate on the "published_by" field.
func PublishedByGTE(v uuid.UUID) predicate.App {
	return predicate.App(sql.FieldGTE(FieldPublishedBy, v))
}

// PublishedByLT applies the LT predicate on the "published_by" field.
func PublishedByLT(v uuid.UUID) predicate.App {
	return predicate.App(sql.FieldLT(FieldPublishedBy, v))
}

// PublishedByLTE applies the LTE predicate on the "published_by" field.
func PublishedByLTE(v uuid.UUID) predicate.App {
	return predicate.App(sql.FieldLTE(FieldPublishedBy, v))
}

// PublishedByIsNil applies the IsNil predicate on the "published_by" field.
func PublishedByIsNil() predicate.App {
	return predicate.App(sql.FieldIsNull(FieldPublishedBy))
}
